...
internal extension UIDevice {
	...
	///
	/// For devices running in the simulator, this will retrieve the simulated device's model identifier.
	/// For physical devices, it will return the actual device's model identifier.
	///
